...
// We could just check and see if the the amount of n and s and the amount of e and w in the array are equal
// But I thought it was neat to actually track the position.
...
function isValidWalk(walk) {
    ...
    let position = [0, 0]; // First element is n/s, second is w/e
